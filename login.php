            ...
            <div class="col-md-6 col-xl-5">
              ...
              <div class="card">
                <div class="card-body z-depth-2 px-4">
                    <p class="lead text-center pt-2 mb-5">LOG IN</p>
                    <?php
                      ...
                      if ($message == 'notmatched') {
                        ...
                        echo "<p style='color:blue'>Now please login</p>";
                      }
                      }
                      ?>
                  <div class="md-form">
                  ...
                  <div align = "center">New User? <a href="sign_up.php">Create an account</a></div>
                </div>
